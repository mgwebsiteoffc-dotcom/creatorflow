    ...
    public function run(): void
    {
        ...
        $posts = [
            [
                ...
                'read_minutes' => '9 min',
                'meta_title'   => 'Influencer Marketing Agency Cost in Delhi (2026 Guide) · CreatorFlow',
                ...
                'faq_json' => [
                    ['q' => 'Which is cheaper — a Delhi influencer marketing agency or hiring in-house?', 'a' => 'For most DTC brands under ₹5Cr revenue, an agency (or platform like CreatorFlow) is 40-60% cheaper than in-house. A single in-house influencer marketer costs ₹8-15L/year fully loaded; a growth-tier CreatorFlow account is ₹149-499/mo.'],
                    ...
                    ['q' => 'Do Delhi agencies handle GST invoicing correctly?', 'a' => 'Reputable ones do. CreatorFlow generates GST-compliant invoices with GSTIN and reverse-charge logic built in.'],
                ],
            ],
            [
                ...
                'read_minutes' => '7 min',
                'meta_title'   => 'Best UGC Influencers in Delhi for DTC Brands (2026) · CreatorFlow',
                ...
                'faq_json' => [
                    ['q' => 'How many UGC influencers does Delhi have?', 'a' => 'CreatorFlow tracks 22,000+ active creators based in Delhi NCR. Of those, roughly 8,400 are UGC-focused (video-first, 15-45s formats).'],
                    ['q' => 'What\'s a fair UGC video rate in Delhi?', 'a' => 'Nano (1-10K followers): ₹2,000-₹8,000. Micro (10-100K): ₹8,000-₹40,000. Mid (100K-1M): ₹40K-₹1.5L. Use CreatorFlow\'s free rate calculator.'],
            ...
            [
                ...
                'category' => 'Playbooks',
                'excerpt' => 'From zero cash to 4-8× ROAS — the exact barter playbook 1,000+ DTC brands run on CreatorFlow.',
                'cover_gradient' => 'from-pink-500 to-rose-500',
                'read_minutes' => '11 min',
                'meta_title'   => 'Barter Influencer Marketing in India · 2026 Guide · CreatorFlow',
                ...
                'faq_json' => [
                    ...
                    ['q' => 'Do Indian creators really accept barter?', 'a' => 'Yes — 62% average across CreatorFlow India. Beauty hits 78%, food 65%, fashion 55%. Higher when the product is genuinely desirable and matches the creator\'s niche.'],
                    ['q' => 'Is barter influencer marketing legal in India?', 'a' => 'Yes. It\'s treated as barter under the Income Tax Act. Both sides recognize the market value of exchanged goods/services. CreatorFlow contracts codify this.'],
                    ['q' => 'How many creators should I seed for a launch?', 'a' => 'For a launch: 30-50 creators. For maintenance: 10-15/month. CreatorFlow auto-invites 3× your target based on a 30% accept-rate assumption.'],
                ],
            ],
            [
                ...
                'read_minutes' => '8 min',
                'meta_title'   => 'Shopify Influencer Attribution in India · CreatorFlow',
                ...
                'faq_json' => [
                    ['q' => 'How do I attribute Shopify sales to influencers?', 'a' => 'Three layers: (1) unique discount code per creator (last-click), (2) UTM referral link (assisted), (3) multi-touch attribution across the buyer journey. CreatorFlow ships all three on install.'],
                    ['q' => 'Does Shopify have native creator attribution?', 'a' => 'No — Shopify tracks the code and the referrer separately, but doesn\'t roll them up per creator. That\'s what apps like CreatorFlow add.'],
            ...
            [
                ...
                'read_minutes' => '6 min',
                'meta_title'   => 'UGC Influencers: Mumbai vs Delhi Comparison · CreatorFlow',

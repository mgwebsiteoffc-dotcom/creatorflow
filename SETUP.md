# CreatorPlex — Setup & Code Map

A production-shaped Laravel 11/13 + MySQL implementation of the CreatorPlex
...
#   create database creatorplex; set DB_* in .env
...
| Role | Email | Password |
|------|-------|----------|
| Brand (Glow & Co., Pro plan, Shopify-connected) | `brand@creatorplex.test` | `password` |
| Creator (Jamie Rivera) | `creator@creatorplex.test` | `password` |

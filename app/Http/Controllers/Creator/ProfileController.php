...
class ProfileController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            'rate_ugc_cents' => ['nullable', 'integer', 'min:0'],
            'rate_video_cents' => ['nullable', 'integer', 'min:0'],
            'rate_post_cents' => ['nullable', 'integer', 'min:0'],
            'rate_story_cents' => ['nullable', 'integer', 'min:0'],
        ...
        $creator->fill([
            ...
            'city' => $data['city'] ?? null,
            'niches' => $data['niches'] ?? [],
            'rate_ugc_cents' => $data['rate_ugc_cents'] ?? null,
            'rate_video_cents' => $data['rate_video_cents'] ?? null,
            'rate_post_cents' => $data['rate_post_cents'] ?? null,
            'rate_story_cents' => $data['rate_story_cents'] ?? null,

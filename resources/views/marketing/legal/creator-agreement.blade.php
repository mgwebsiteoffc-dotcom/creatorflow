<x-marketing.legal-layout title="Creator Agreement"
    ...
    <h2>3. Payouts</h2>
    <ul>
        <li>Cash payouts are sent via Stripe Connect / UPI once escrow is released. Minimum payout is set by the platform admin.</li>
        <li>Barter shipments are the brand's responsibility.</li>
    </ul>

    <h2>4. Content and rights</h2>
    <ul>
        <li>You own your content. You grant the brand the usage rights stated in the accepted brief (default: 90-day paid usage).</li>
        <li>You must comply with our <a href="{{ route('legal.content') }}">Content Guidelines</a>.</li>
    </ul>

    <h2>5. Fraud, fake followers, off-platform payments</h2>
    <p>Buying followers, using engagement bots, or asking brands to pay you off-platform will result in immediate suspension and forfeiture of pending payouts.</p>

    <h2>6. Termination</h2>
    <p>You may delete your account any time from Profile → Settings. Pending payouts release once open contracts are complete.</p>

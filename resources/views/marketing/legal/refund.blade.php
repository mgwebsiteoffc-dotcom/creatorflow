<x-marketing.legal-layout title="Refund Policy"
    ...
    <ul>
        <li>Money deposited into campaign escrow can be withdrawn back to the brand at any time before it is released to a creator.</li>
        <li>Once a creator delivers approved content, the fee is released after the escrow hold window (default 7 days, editable in <em>Admin → Settings</em>). Released funds are non-refundable.</li>
        <li>If a creator fails to deliver against a signed contract, brands can dispute and receive a full refund of the held funds. Disputes are resolved within 14 business days.</li>
    </ul>

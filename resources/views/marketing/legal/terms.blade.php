<x-marketing.legal-layout title="Terms of Use"
    ...
    <ul>
        <li>Every brand belongs to a "workspace" — one billing entity with roles: owner, admin, manager, analyst.</li>
        <li>You are responsible for all activity under your account. Keep your password secret. Notify us within 24 hours of any suspected unauthorised access.</li>
        <li>We may suspend accounts that violate these Terms, contain fraudulent activity, or fail payment.</li>
    </ul>
    ...
    <ul>
        <li>Brands pay creator fees + a platform fee (currently 10% for paid, 5% for barter) + payment processing markup.</li>
        <li>Paid fees are held in escrow for the number of days set in <em>Admin → Settings</em> (default 7 days) after content is approved.</li>
        <li>Refunds for approved-but-unused campaign funds return to the brand's original payment method within 7 business days.</li>
        <li>Creator payouts are sent via Stripe Connect (or the enabled provider) after the escrow window ends.</li>
    </ul>

    <h2>5. Content licensing</h2>
    <p>Unless a campaign brief states otherwise, brands receive a 90-day paid usage license on delivered content for the geography you operate in. Perpetual buyouts, exclusivity, and whitelisting must be negotiated separately in the campaign brief.</p>
    ...
    <h2>10. Changes</h2>
    <p>We may update these Terms. Material changes are notified in-app 14 days before they take effect.</p>

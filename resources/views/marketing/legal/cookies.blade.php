<x-marketing.legal-layout title="Cookie Policy"
    ...
    <h2>2. Analytics (with consent)</h2>
    <ul>
        <li>Anonymous page view + event data via a first-party analytics endpoint. No third-party trackers.</li>
    </ul>

    <h2>3. Marketing</h2>
    <p>We do not run third-party ad-tracking cookies.</p>

    <h2>4. Managing cookies</h2>
    <p>You can clear or block cookies in your browser settings. Blocking strictly necessary cookies will break sign-in.</p>

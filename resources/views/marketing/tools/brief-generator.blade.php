<x-layouts.app panel="guest"
    ...
    @php
        $briefFaqLd = [
            ...
            'mainEntity' => [
                ...
                ['@type' => 'Question', 'name' => 'Is the AI brief generator free?',
                 'acceptedAnswer' => ['@type' => 'Answer', 'text' => 'Yes. This tool is 100% free with no signup. You get an editable brief you can paste into WhatsApp, email, a CreatorPlex campaign or your own doc.']],
                ['@type' => 'Question', 'name' => 'Does the brief work for Indian creators?',
                 'acceptedAnswer' => ['@type' => 'Answer', 'text' => 'Yes — hooks, tone and shot list are tuned for the Indian Reels/YouTube Shorts market. The output plugs directly into a CreatorPlex campaign where you can send it to matched creators in Delhi, Mumbai, Bangalore and beyond.']],
        ...
        $swAppLd = [
            ...
            'name' => 'CreatorPlex AI Brief Generator',
            ...
            <div>
                <div class="g-border p-1 shadow-xl">
                    <div class="rounded-[calc(1.25rem-1px)] bg-white p-6 space-y-4">
                        ...
                        @if(config('creatorplex.ai.driver') === 'openai' && config('creatorplex.ai.openai.key'))
...
Generated by CreatorPlex · ${new Date().toISOString().slice(0,10)}
...
━━━ COMPENSATION
As agreed in your CreatorPlex contract.
...
`;
    ...
    <section class="mx-auto max-w-4xl px-4 pb-16">
        <div class="prose prose-slate max-w-none">
            ...
            <p class="text-slate-600">
                The best-performing creator briefs on CreatorPlex — across Delhi beauty, Mumbai fashion, Bangalore tech and Chennai food brands — share the same structure. Ambiguity is the enemy of ROAS. Give the creator hooks, shot list and must-includes; give them freedom on execution.
            </p>
            ...
            <p class="text-slate-600">
                A blank Google Doc is the #1 reason campaigns get delayed. This generator gives you a fully-shaped starting point in under 5 seconds — you keep the strategic thinking, we handle the boilerplate. Every brief is editable, copy-pasteable, and drops cleanly into a CreatorPlex campaign or a WhatsApp message.
            </p>
    ...
    @include('marketing._cta', ['title' => 'Briefs are 1% of the work. Automate the other 99%.', 'sub' => 'CreatorPlex generates briefs, sends them, tracks acceptance, and reviews content.'])
</x-layouts.app>
